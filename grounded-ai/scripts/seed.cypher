...
WITH [
  {inference_id:'AI00001', image_id:'IMG_001', encounter_id:'E0003', model:'llava-1.5-7b', model_version:'v1.0', task:'caption', output:'Chest X-ray – probable right upper lobe nodule (~1.8 cm). Recommend CT follow-up.', confidence:0.91, timestamp:'2025-10-10T12:00:00', source_type:'observation', source_reference:'O00004', role:'vision'}
] AS rows
UNWIND rows AS r
MATCH (enc:Encounter {encounter_id:r.encounter_id})
