...
WITH [
  {image_id:'CT001', modality:'CT', storage_uri:'/data/dummy/CT001.png'},
  {image_id:'US001', modality:'US', storage_uri:'/data/dummy/US001.png'},
  {image_id:'XR001', modality:'XR', storage_uri:'/data/dummy/XR001.png'}
] AS imgs
UNWIND imgs AS r
...
WITH [
  {id:'F001', type:'mass', location:'right lobe', size_cm:3.5, conf:0.9},
  {id:'F002', type:'nodule', location:'RUL', size_cm:1.6, conf:0.85},
  {id:'F003', type:'ischemic', location:'MCA', size_cm:2.1, conf:0.8},
  {id:'F004', type:'steatosis', location:'liver', size_cm:0.0, conf:0.92}
] AS fds
UNWIND fds AS f
...
WITH [
  {id:'R001', text:'Hepatic steatosis with focal mass suspicion.', conf:0.88},
  {id:'R002', text:'Right upper lobe pulmonary nodule.', conf:0.82},
  {id:'R003', text:'Ischemic change in MCA territory.', conf:0.86}
] AS reps
UNWIND reps AS r
MERGE (rep:Report {id:r.id})
SET rep.text=r.text, rep.conf=toFloat(r.conf);

MATCH (i1:Image {image_id:'CT001'}),
      (i2:Image {image_id:'US001'}),
      (i3:Image {image_id:'XR001'}),
      (f1:Finding {id:'F001'}),
      (f2:Finding {id:'F002'}),
      (f3:Finding {id:'F003'}),
      (f4:Finding {id:'F004'}),
